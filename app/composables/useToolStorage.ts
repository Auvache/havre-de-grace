/**
 * localStorage for the /resources tools, with every failure mode handled.
 *
 * The tools have no backend, so the browser is the only place progress can
 * live. That is fine, and it is
...
const STORAGE_PREFIX = 'hdg-tools'
